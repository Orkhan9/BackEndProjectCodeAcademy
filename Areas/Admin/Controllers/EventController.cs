...
namespace EducationBackendFinal.Areas.Admin.Controllers
{
    ...
    public class EventController : Controller
    {
        ...
        public IActionResult Detail(int? id)
        {
            ...
            UpComingEvent upComingEvent = _db.UpComingEvents.Include(c=>c.Category).Include(c => c.SpeakerEvents).
        ...
        public IActionResult Update(int? id)
        {
            ...
            if (id == null) return View();
            UpComingEvent upComingEvent = _db.UpComingEvents.Include(c => c.SpeakerEvents).
                ThenInclude(c => c.Speaker).FirstOrDefault(p => p.Id == id);
